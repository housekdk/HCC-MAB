...
class CommonParams(object):
    ...
    """
    def __init__(self, slack_token, host=None, port=None, num_news_display=5, description_length=200):
        ...
        self.num_news_display = num_news_display  # 사용자에게 보여줄 뉴스 건수
        self.description_length = description_length  # 뉴스 요약 길이
