...
# footer = by News                 # 이 부분을 주석(#)화하면, 각 뉴스마다 제공자를 보여 주고, 주석 제거하면 이 문자열로 대체됨
...
author_icon = https://avatars3.githubusercontent.com/u/162998?v=3&s=88   # highlight_featured = yes일 때 아바타 이미지
default_redirect_link = https://github.com                               # 기사를 누를 때 링크가 깨졌다면, 대신 이 링크로 리다이렉션
...
variation1 = 인공지능,핀테크,데이터과학,연구     # variation 1~3: 이 키워드로 구글 뉴스를 검색해 옴. 쉼표로 구분하여 여러 키워드 지정
variation2 = 인공지능,게임,영화,연예
variation3 = 인공지능,날씨,재테크,정치

[FILE]
use_sqlite = yes                   # yes의 경우 아래의 sqlite_database를 사용하며 pickle_로 시작하는 파일은 사용하지 않음
